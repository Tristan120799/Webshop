...
<!--            </div>-->
            <div class="uk-card-body uk-flex uk-flex-between uk-card-body-gap">
               <div class="uk-width-1-3">
                  <img src="img/logo.png" class="uk-card-media uk-card-body-login-logo" alt="Webshop the game knight" title="Webshop the game knight" />
                  <div class="uk-flex uk-flex-column uk-flex-middle">
                     <p class="uk-text-center uk-margin-remove-bottom uk-text-muted">Webshop</p>
                     <h4 class="uk-text-uppercase uk-text-center uk-margin-remove-vertical uk-text-muted">the game knight</h4>
                  </div>
               </div>
